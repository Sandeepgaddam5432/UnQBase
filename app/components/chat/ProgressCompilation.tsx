      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-unqbase-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-unqbase-elements-item-backgroundAccent hover:bg-unqbase-elements-artifacts-backgroundHover"
