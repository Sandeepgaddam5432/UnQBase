      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-unqbase-elements-textPrimary dark:text-unqbase-elements-textPrimary-dark'
              : 'text-unqbase-elements-textSecondary dark:text-unqbase-elements-textSecondary-dark hover:text-unqbase-elements-textPrimary dark:hover:text-unqbase-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-unqbase-elements-textTertiary dark:text-unqbase-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
