        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-unqbase-elements-background-depth-2 dark:bg-unqbase-elements-background-depth-3 text-unqbase-elements-textPrimary dark:text-unqbase-elements-textPrimary-dark hover:bg-unqbase-elements-background-depth-3 dark:hover:bg-unqbase-elements-background-depth-4 border border-unqbase-elements-borderColor dark:border-unqbase-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
