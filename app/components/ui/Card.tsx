  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-unqbase-elements-borderColor bg-unqbase-elements-background-depth-1 text-unqbase-elements-textPrimary shadow-sm frosted',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-unqbase-elements-textSecondary', className)} {...props} />;
  },
);
