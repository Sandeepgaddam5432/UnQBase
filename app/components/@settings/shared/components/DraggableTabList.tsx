    ...
    >
      <div className="flex items-center gap-4">
        <div className="cursor-grab">
          <div className="i-ph:dots-six-vertical w-4 h-4 text-unqbase-elements-textSecondary" />
        </div>
        <div>
          <div className="font-medium text-unqbase-elements-textPrimary">{TAB_LABELS[tab.id]}</div>
          {showControls && (
            <div className="text-xs text-unqbase-elements-textSecondary">
      ...
      {showControls && !tab.locked && (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm text-unqbase-elements-textSecondary">Visible</label>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm text-unqbase-elements-textSecondary">User</label>
            <Switch
            ...
            />
            <label className="text-sm text-unqbase-elements-textSecondary">Dev</label>
          </div>
        </div>
      )}
    </motion.div>
